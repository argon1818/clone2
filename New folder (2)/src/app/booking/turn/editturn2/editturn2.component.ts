...
@Component({
  selector: 'app-editturn2',
  templateUrl: './editturn2.component.html',
  styleUrls: ['./editturn2.component.scss']
})
export class Editturn2Component implements OnInit {
 ...
 public GetStartHourFunction(e:Event){
  ...
  editTurn(){
    ...
    this.BookingService.EditTurn(data).subscribe((res:any)=>{
      ...
      if (res.status==200){
        ...
        this.router.navigate(['dashboard1/addturn/'+this.office_doctor_id])
  ...
  ReturnTo1(){
    ...
    this.router.navigate(['dashboard1/addturn/'+this.office_doctor])
  }
